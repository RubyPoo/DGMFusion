...
from al3d_det.utils.attention_utils import TransformerEncoder, get_positional_encoder,DWT_2D, IDWT_2D
...
class VoxelAggregationHead(RoIHeadTemplate):
    ...
    def forward(self, batch_dict):
        ...
        if self.pool_cfg.get('ATTENTION', {}).get('ENABLED'):
            ...
            # attention_output = self.attention_head(pooled_features, positional_input, None) # (BxN, 6x6x6, C)
